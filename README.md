...
<img src="res/Fideo_White.png#gh-dark-mode-only" width=300><br>
<img src="res/Fideo_Black.png#gh-light-mode-only" width=300><br>
...
- Encode files to MP4 format
- Decode encoded MP4 files back to their original files
- Extension bypass
...
```bash
f2v <input_file> [-o <output_video>] [-r <even_resolution>]
```
